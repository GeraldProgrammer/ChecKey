...
<body style="background-color: #333;">
	...
	<form class="formulario"  method="POST" action="insertar.php" >
		<h1 class="formulario__titulo" style="color: dodgerblue;"> Registrar usuario</h1>
		
		<br>
		<br>

		<input type="text" style="color:dodgerblue ;" class="formularioinput"  required autofocus name="nombre">
		<label for="" class="formulario__label"  >Nombre completo</label>
		<br>

		<input type="email" style="color:dodgerblue ;" class="formularioinput" required autofocus  name="correo" >
		<label for="" class="formulario__label">Correo</label>
		<br>

		<input type="text" style="color:dodgerblue ;" class="formularioinput" required autofocus  name="telefono" >
		<label for="" class="formulario__label">Telefono</label>
		<br>
		
		<input style="color:dodgerblue ;" type="time" class="formularioinput" required autofocus  name="horario_entrada">
		<label for="" class="formulario__label">Horario de entrada</label>
		<br>

		<input type="text" style="color:dodgerblue ;" class="formularioinput" required autofocus  name="direccion">
		<label for="" class="formulario__label">Direccion</label>
		<br>
		
		<input type="text" style="color:dodgerblue ;" class="formularioinput" required autofocus  name="nombre_usuario">
		<label for="" class="formulario__label">Nombre de usuario</label>
		<br>

		<input type="password" style="color:dodgerblue ;" class="formularioinput" required autofocus  name="contraseña">
