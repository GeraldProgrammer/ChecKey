...
<html>
<head>
	<title>Lenguajes de programacion utilizados</title>
...
<body style="background-color: #333;">
	...
	<fieldset class="cu">
		<legend><h2 ><font color="grey">  Lenguajes de programacion utilizados.</font></h2></legend>
		<p style="color: white; text-align: left; font-size: 14pt; font-family: Arial;" >
			<img src="Imagenes/html.png" width="80" height="80" aling="right"hspace="10" align="left">
   ...
   <p style="color: white; text-align: left; font-size: 14pt; font-family: Arial;" >
			<img src="Imagenes/css.png" width="80" height="80" aling="right"hspace="10" align="left">
   ...
   <p style="color: white; text-align: left; font-size: 14pt; font-family: Arial;" >
			<img src="Imagenes/js.png" width="80" height="80" aling="right"hspace="10" align="left">
...
Se utiliza principalmente en su forma del lado del cliente (client-side), implementado como parte de un navegador web permitiendo mejoras en la interfaz de usuario y páginas web dinámicas4​ aunque existe una forma de JavaScript del lado del servidor (Server-side JavaScript o SSJS). Su uso en aplicaciones externas a la web, por ejemplo en documentos PDF, aplicaciones de escritorio (mayoritariamente widgets) es también significativo.
    ...
    <p style="color: white; text-align: left; font-size: 14pt; font-family: Arial;" >
			<img src="Imagenes/php.png" width="80" height="80" aling="right"hspace="10" align="left">
